...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/authenticatorpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11985&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/authenticatorpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `authenticatorpy` can be installed with:

```
conda install authenticatorpy
```

It is possible to list all of the versions of `authenticatorpy` available on your platform with:
